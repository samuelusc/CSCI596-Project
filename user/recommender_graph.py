...
def load_data():
    with driver.session() as session:
        ...
        session.run("""
            LOAD CSV WITH HEADERS FROM "http://localhost:11001/project-bd0e89c8-800f-414e-95a6-696049426702/out_movies.csv" AS csv
        ...
        session.run("""
            LOAD CSV WITH HEADERS FROM "http://localhost:11001/project-bd0e89c8-800f-414e-95a6-696049426702/out_grade.csv" AS csv
        ...
        session.run("""
            LOAD CSV WITH HEADERS FROM "http://localhost:11001/project-bd0e89c8-800f-414e-95a6-696049426702/out_genre.csv" AS csv
            MERGE (m:Movie {title: csv.title})
        ...
        session.run("""
            LOAD CSV WITH HEADERS FROM "http://localhost:11001/project-bd0e89c8-800f-414e-95a6-696049426702/out_keyword.csv" AS csv
            MERGE (m:Movie {title: csv.title})
        ...
        session.run("""
            LOAD CSV WITH HEADERS FROM "http://localhost:11001/project-bd0e89c8-800f-414e-95a6-696049426702/out_productor.csv" AS csv
            MERGE (m:Movie {title: csv.title})
